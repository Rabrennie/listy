...
},{"./controllers/List":2}],2:[function(require,module,exports){
'use strict';
...
var Q = require('q');
var asyncSort = Q.nfbind(require('async-merge-sort'));

_module3.default.controller('List', function ($scope, $rootScope, $location) {
  ...
  if ($location.$$path !== '/start' && !$rootScope.list) {
    ...
    var humanSort = function humanSort(arr) {
      console.log(arr);
      return asyncSort(arr, function (a, b, cb) {
        ...
        var listener = $scope.$watch('selected', watchCb);
      });
    };

    humanSort(arr).then(function (value) {
  ...
  $scope.chooseStep = function () {
    $rootScope.list = $scope.list;
    $location.path('/choose');
  };
});

},{"../module":3,"async-merge-sort":4,"q":7}],3:[function(require,module,exports){
'use strict';
...
var _module = angular.module('Listy', ['ui.router']);
